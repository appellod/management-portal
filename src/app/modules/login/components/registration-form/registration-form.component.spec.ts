    ...
    describe('register()', () => {
        ...
        describe('when the form is invalid', () => {
            it('has requirement errors', () => {
                ...
                expect(component.form.get('passwords').get('password').hasError('required')).toBeTruthy();
                expect(component.form.get('passwords').get('confirmPassword').hasError('required')).toBeTruthy();
            });
